...
export default function ContactSectionMission({ sectionType }) {
  ...
  return (
    ...
    <section className={`split-page max-lg:py-12`}>
      <div className={`grow-1 basis-0 lg:mr-8 app-color--${sectionType} max-lg:px-8 pt-12 pb-18 g:py-24`}>
        <HeaderUnderline
          title="Contact Form"
      ...
      <div className={`grow-1 basis-0 lg:ml-8 app-color--${sectionType}-split max-lg:px-8 py-8 lg:py-24`}>
        <form>
