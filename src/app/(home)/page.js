...
export default function HomePage() {
  return (
    <div className="">
      <section className={"home-landing-background"}>
      ...
      <section className={`general-section-light`}>
        ...
        <div className={`general-section-container`}>
          <p className={`section-paragraph`}>
            ...
            enhance public services in Fresno and the Central Valley area. Our
            community thrives on collaboration, innovation, and a shared
            commitment to driving positive change.
          </p>
        </div>
      </section>
      <section
        className={`general-section-dark home-section-dark-flex home-about-image`}
      >
        <div className={`home-about-container`}>
          ...
          >
            <h1
              className={`general-heading-section general-heading-section-alt`}
            >
              What we do
            </h1>
            <h2 className={`sub-heading`}>
        ...
        <div className={`home-numbered-grid`}>
          <div className={`home-numbered-container`}>
            ...
            <p className={`home-numbered-paragraph`}>
              ...
              on projects at our meetups. Join us to be a part of a vibrant
              community dedicated to positive change through technology.
            </p>
            <Button
          ...
          <div className={`home-numbered-container`}>
            ...
            <p className={`home-numbered-paragraph`}>
              ...
              address real challenges and enhance our city. Be part of a dynamic
              team working on solutions that make a difference.
            </p>
            <Button
              className={`btn btn-alt-gold`}
              href="/projects"
      ...
      <section className={`general-section-dark home-projects-section`}>
        <div className={`home-projects-info-container`}>
          <div
            className={`home-section-dark-container heading-underline underline-alt`}
          >
            <h1
              className={`general-heading-section general-heading-section-alt`}
            >
          ...
          <p className={`section-paragraph`}>
            We tackle tech projects addressing civic issues, enhancing services
            in Fresno. From open data initiatives to government services and
            community platforms,
            <span className={`paragraph-bold`}>
              {" "}
