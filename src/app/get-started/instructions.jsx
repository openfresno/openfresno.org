const instructions = [
  {
    ...
    body: (
      <>
        Before diving into projects and collaborations, familiarize yourself
        with our{" "}
  ...
  },
  {
    ...
    body: (
      <>
        Immerse yourself in Open Fresno by joining our weekly meetings. Meet
        volunteers, discuss projects, and contribute. Stay updated via Slack and
        Meetup. Your active participation helps engage with the community, share
        ideas, and find your ideal project. See you at the next{" "}
        <a
          className="primary-link--underline"
