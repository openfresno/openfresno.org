const instructions = [
  ...
  },
  {
    ...
    body: (
      <>
        Familiarize yourself with our Code of Conduct, which outlines the
        principles and expectations guiding our community. We value respectful
        and inclusive interactions to create a positive environment for
        everyone. Please read and understand{" "}
        <a
  ...
  },
  {
    ...
    body: (
      <>
        ...
        to formally propose your idea. After submitting, please allow 1-2 weeks
        for our team to review your project proposal. We&apos;ll carefully
  ...
  },
  {
    ...
    body: (
      <>
        For the fastest way to engage with our community and potentially pitch
        your project, consider attending our weekly meetings posted on{" "}
        <a
          className="primary-link--underline"
        ...
        . These meetings provide an excellent opportunity to connect with our
  ...
  },
  {
    ...
    body: (
      <>
        After submitting your project form, please patiently wait for approval
        or notification of rejection.Once your project is approved, a team
