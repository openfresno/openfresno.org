...
export default function AboutSectionLanding({ sectionType }) {
  return (
    ...
    >
      <span className={"font-semibold"}>We are a passionate and diverse group of technologists, developers,
        designers, and civic-minded individuals united by a common goal:</span>{" "}
