...
export default function AboutSectionPositionList({
  ...
  return(
    <div className={`w-[48%] max-lg:ml-[6%] min-w-[400px] max-lg:w-full max-sm:min-w-0 positions-container mb-4`}>
      ...
      <ul className={`positions-list list-disc mt-4`}>
        {
          listText.map((text, i) => {
            return (<li key={i} className={`text-(--neutral-200) text-xl/10 `}>{text}</li>)
          })
        }
      </ul>
    </div>
